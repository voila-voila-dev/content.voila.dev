...
// per slug in `localStorage`; the pane only renders on desktop — below
// 1024px the host renders the plain form. The `src` is derived from the
// document, so an edited slug moves the frame to the new URL.
...
export function PreviewSplit({ slug, target, doc, focus, children }: PreviewSplitProps): ReactNode {
