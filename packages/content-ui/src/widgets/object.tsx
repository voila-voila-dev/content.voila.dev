...
// emitting the whole record on every edit and `undefined` once every member is
// blank so an optional object goes back to "not provided". Without `meta.shape`
// (a hand-built field) it degrades to the unsupported-input notice.
