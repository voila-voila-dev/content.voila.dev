// The create-post page. CollectionForm derives its fields, widgets, and
// client-side validation from the collection config — the same contract the
// REST write path enforces server-side.
