...
export const Route = createRootRoute({
  head: () => {
    // Title + favicon from `admin.branding` (with the inline mark above as the
    // fallback favicon); the route owns the rest of the document <head>. Set
    // `branding.title` / `branding.favicon` in `app/lib/admin.ts` to customize.
