...
//
// This one config drives BOTH halves of the app: the public pages readers see
// and the `/admin` they are edited in. Change a field here and it appears in
// the admin's form, in the database schema, and in the typed client at once.
