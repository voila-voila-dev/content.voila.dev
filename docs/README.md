...
**Evergreen** (what the product is and why):

- [philosophy.md](./philosophy.md) — what we're building and the principles
- [tech-decisions.md](./tech-decisions.md) — the load-bearing choices
